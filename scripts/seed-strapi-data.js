...
const collections = {
  ...
  post: [
    { title: "Expanding Agricultural Credit in Southern India", slug: "expanding-agri-credit-south-india", excerpt: "How South Urban Agro is accelerating low-interest credit for smallholders.", category: "Finance", author: "Editorial Team", date: "2026-08-10", readTime: "4 min read", order: 1, published: true },
    { title: "Modern Organic Farming Practices & Yield", slug: "modern-organic-farming-practices", excerpt: "Key guidelines for transitioning to high-value organic crops.", category: "Farming", author: "Agri Expert", date: "2026-08-01", readTime: "5 min read", order: 2, published: true }
  ],
  service: [
